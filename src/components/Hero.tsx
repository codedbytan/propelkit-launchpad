        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 animate-fade-up stagger-2">
              ...
              <span className="font-semibold text-foreground">Indian compliance</span> built-in. Stop wasting weeks on
              payment integration—start selling today.
            </p>
            ...
            <div className="mt-6 lg:hidden">
              <div className="bg-[#0a0a0a] border border-white/10 overflow-hidden">
                ...
                <div className="p-4 font-mono text-xs min-h-[160px]">
                  ...
                  {visibleLines < terminalLines.length && <span className="animate-pulse text-primary">▋</span>}
                </div>
              </div>
            </div>
          </div>
